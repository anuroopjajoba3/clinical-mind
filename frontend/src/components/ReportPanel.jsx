        ...
        {report.followup_questions?.length > 0 && (
          <div className="mt-6 pt-5 border-t border-gray-100">
            <div className="flex items-center gap-2 mb-3">
              ...
              <span className="ml-auto text-xs text-gray-400">based on evidence gaps</span>
            </div>
            <div className="flex flex-col gap-2">
              {report.followup_questions.map((q, i) => (
                <button
                  ...
                  className="group flex items-start gap-3 w-full text-left px-4 py-3 rounded-xl
                             bg-gradient-to-r from-slate-50 to-blue-50/40
                             border border-slate-200 hover:border-blue-300 hover:from-blue-50 hover:to-indigo-50/40
                ...
                >
                  ...
                  <span className="text-sm text-slate-700 group-hover:text-slate-900 leading-relaxed transition-colors">
                    {q}
                  </span>
                  <span className="flex-shrink-0 text-slate-300 group-hover:text-blue-500 transition-colors mt-0.5">
                    →
                  </span>
                </button>
              ))}
