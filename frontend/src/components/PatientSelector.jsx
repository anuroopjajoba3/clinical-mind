...
import { User, Activity, Pill, FlaskConical, AlertCircle, ChevronRight, X, RefreshCw } from 'lucide-react'
import api from '../api'
...
export default function PatientSelector({ onPatientSelected }) {
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 max-h-96 overflow-y-auto pr-1">
          <AnimatePresence>
            {patients.map((p, i) => (
              ...
              >
                <PatientCard patient={p} onSelect={handleSelect} selected={selected} />
              </motion.div>
            ))}
          </AnimatePresence>
        </div>
